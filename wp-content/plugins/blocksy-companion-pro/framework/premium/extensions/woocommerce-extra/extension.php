	...
	public function __construct() {
		...
		add_action(
			...
			function () {
				...
				if (get_theme_mod('product_has_share_box', 'yes') === 'no') {
					return;
				}
		...
		add_filter('blocksy:frontend:dynamic-js-chunks', function ($chunks) {
			...
			$chunks[] = [
				...
				'selector' => '[class*="ct-wishlist-button"], .ct-wishlist-remove, .wishlist-product-remove > .remove, .product-mobile-actions > .remove',
				'url' => blc_call_fn(
					[
						'fn' => 'blocksy_cdn_url',
