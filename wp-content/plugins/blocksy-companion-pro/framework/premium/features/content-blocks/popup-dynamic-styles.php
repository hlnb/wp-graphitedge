...
blocksy_output_spacing([
	...
	'value' => blocksy_default_akg('popup_padding', $atts,
...
blocksy_output_spacing([
	...
	'value' => blocksy_default_akg('popup_border_radius', $atts,
		blocksy_spacing_value([
			'linked' => true,
		])
	)
...
blocksy_output_colors([
	...
	'variables' => [
		'default' => [
			'selector' => blocksy_prefix_selector(' .ct-close-button', 'block:' . $id),
			'variable' => 'icon-color'
		],
...
blocksy_output_background_css([
	'selector' => blocksy_prefix_selector(' .ct-popup-inner', 'block:' . $id),
	'css' => $css,
	'value' => blocksy_default_akg('popup_background', $atts,
