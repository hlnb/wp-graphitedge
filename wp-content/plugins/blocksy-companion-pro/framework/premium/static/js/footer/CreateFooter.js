			...
			<Overlay
				...
				render={() => (
					<div className="ct-modal-content">
						<h1>{sprintf(__('Create new footer', 'blc'))}</h1>
						...
						<div className="ct-create-instance-content">
							<div className="ct-option-input">
								<label>{__('Footer name', 'blc')}</label>
								...
								<input
									...
									placeholder={__('Footer name', 'blc')}
								/>
							</div>
							...
							<div
								...
								<div
									...
									{__('Copy elements & styles from', 'blc')}
								</div>
