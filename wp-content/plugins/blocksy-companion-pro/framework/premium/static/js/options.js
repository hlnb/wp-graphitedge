...
import { mountStackableFontsIntegration } from './typography/stackable'
import { mountKadenceFontsIntegration } from './typography/kadence'
...
onDocumentLoaded(() => {
	mountStackableFontsIntegration()
	mountKadenceFontsIntegration()
	mountCodeEditor()
	mountHooksSwitch()
