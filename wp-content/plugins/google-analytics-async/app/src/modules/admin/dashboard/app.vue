<template>
	<div class="sui-wrap" id="beehive-wrap">
		...
		<div class="beehive-tutorials-slider-box">
			<tutorials-slider
...
import { TutorialsSlider } from '@wpmudev/react-tutorials'
...
export default {
	...
	computed: {
		...
		/**
		 * Check if we can show tutorials box.
		 *
		 * @since 3.3.7
		 *
		 * @return {boolean}
		 */
		showTutorials() {
			return !this.$vars.whitelabel.hide_doc_link
		},
	},
