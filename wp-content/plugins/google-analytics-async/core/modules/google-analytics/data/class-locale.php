		...
		return array(
			'notice'      => array(
				...
				/* translators: %s: Google support docs link. */
					__( 'At the moment, Google Analytics 4 API is still being perfected, but you can start collecting data and benefit from the latest innovations as they become available. To learn more about it, check out <a href="%s" target="_blank">What\'s new</a>.', 'ga_trans' ),
				...
				'ga4_not_available'          => __( 'Choose your <strong>Universal Analytics</strong> profile to view statistics in your WordPress Dashboard. Note: At the moment, Analytics 4 profiles and statistics are not available as there is no stable API available yet.', 'ga_trans' ),
				'ga4_not_available_selected' => __( 'Note: At the moment, Analytics 4 profiles and statistics are not available as there is no stable API available yet.', 'ga_trans' ),
			),
			'error'       => array(
			...
			'label'       => array(
				...
				'analytics_4'                    => __( 'Analytics 4', 'ga_trans' ),
			...
			'desc'        => array(
				...
				'account'                => __( 'To view analytics data in your Dashboard area, you need to connect and authenticate a Google Analytics account. Alternatively, you can add a tracking ID to start tracking your Google Analytics, you just won\'t be able to view the data here.', 'ga_trans' ),
				'analytics_profile'      => __( 'Authenticate with Google to connect your analytics profile and begin feeding analytics to your WordPress Dashboard.', 'ga_trans' ),
				...
				'analytics_4'            => __( 'Copy and paste your Google Analytics Measurement ID to add it to your website. Note: The new Google Analytics 4 is now the default experience for all new properties.', 'ga_trans' ),
