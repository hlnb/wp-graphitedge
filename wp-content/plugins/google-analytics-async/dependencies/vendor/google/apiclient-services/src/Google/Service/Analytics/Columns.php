 ...
 * the License.
 */
class Google_Service_Analytics_Columns extends \Beehive\Google_Collection
{
 ...
 * the License.
 */
\class_alias('Beehive\\Google_Service_Analytics_Columns', 'Google_Service_Analytics_Columns', \false);