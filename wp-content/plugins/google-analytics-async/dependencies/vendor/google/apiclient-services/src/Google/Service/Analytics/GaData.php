 ...
 * the License.
 */
class Google_Service_Analytics_GaData extends \Beehive\Google_Collection
{
     ...
     */
    public function setDataTable(\Beehive\Google_Service_Analytics_GaDataDataTable $dataTable)
    {
     ...
     */
    public function setProfileInfo(\Beehive\Google_Service_Analytics_GaDataProfileInfo $profileInfo)
    {
     ...
     */
    public function setQuery(\Beehive\Google_Service_Analytics_GaDataQuery $query)
    {
        $this->query = $query;
    }
    /**
 ...
 * the License.
 */
\class_alias('Beehive\\Google_Service_Analytics_GaData', 'Google_Service_Analytics_GaData', \false);