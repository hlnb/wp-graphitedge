 ...
 * the License.
 */
class Google_Service_Analytics_McfData extends \Beehive\Google_Collection
{
     ...
     */
    public function setProfileInfo(\Beehive\Google_Service_Analytics_McfDataProfileInfo $profileInfo)
    {
     ...
     */
    public function setQuery(\Beehive\Google_Service_Analytics_McfDataQuery $query)
    {
        $this->query = $query;
    }
    /**
 ...
 * the License.
 */
\class_alias('Beehive\\Google_Service_Analytics_McfData', 'Google_Service_Analytics_McfData', \false);