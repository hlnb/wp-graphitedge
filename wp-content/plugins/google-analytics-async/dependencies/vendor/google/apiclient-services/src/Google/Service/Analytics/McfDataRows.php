 ...
 * the License.
 */
class Google_Service_Analytics_McfDataRows extends \Beehive\Google_Collection
{
 ...
 * the License.
 */
\class_alias('Beehive\\Google_Service_Analytics_McfDataRows', 'Google_Service_Analytics_McfDataRows', \false);