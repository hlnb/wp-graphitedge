 ...
 * the License.
 */
class Google_Service_Analytics_RealtimeData extends \Beehive\Google_Collection
{
     ...
     */
    public function setProfileInfo(\Beehive\Google_Service_Analytics_RealtimeDataProfileInfo $profileInfo)
    {
     ...
     */
    public function setQuery(\Beehive\Google_Service_Analytics_RealtimeDataQuery $query)
    {
        $this->query = $query;
    }
    /**
 ...
 * the License.
 */
\class_alias('Beehive\\Google_Service_Analytics_RealtimeData', 'Google_Service_Analytics_RealtimeData', \false);