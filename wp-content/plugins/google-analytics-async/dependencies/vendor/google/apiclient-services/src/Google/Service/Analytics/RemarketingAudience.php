 ...
 * the License.
 */
class Google_Service_Analytics_RemarketingAudience extends \Beehive\Google_Collection
{
     ...
     */
    public function setAudienceDefinition(\Beehive\Google_Service_Analytics_RemarketingAudienceAudienceDefinition $audienceDefinition)
    {
     ...
     */
    public function setStateBasedAudienceDefinition(\Beehive\Google_Service_Analytics_RemarketingAudienceStateBasedAudienceDefinition $stateBasedAudienceDefinition)
    {
 ...
 * the License.
 */
\class_alias('Beehive\\Google_Service_Analytics_RemarketingAudience', 'Google_Service_Analytics_RemarketingAudience', \false);