 ...
 * the License.
 */
class Google_Service_AnalyticsReporting_Activity extends \Beehive\Google_Collection
{
     ...
     */
    public function setAppview(\Beehive\Google_Service_AnalyticsReporting_ScreenviewData $appview)
    {
     ...
     */
    public function setEcommerce(\Beehive\Google_Service_AnalyticsReporting_EcommerceData $ecommerce)
    {
     ...
     */
    public function setEvent(\Beehive\Google_Service_AnalyticsReporting_EventData $event)
    {
        $this->event = $event;
    }
    /**
     ...
     */
    public function setGoals(\Beehive\Google_Service_AnalyticsReporting_GoalSetData $goals)
    {
        $this->goals = $goals;
    }
    /**
     ...
     */
    public function setPageview(\Beehive\Google_Service_AnalyticsReporting_PageviewData $pageview)
    {
 ...
 * the License.
 */
\class_alias('Beehive\\Google_Service_AnalyticsReporting_Activity', 'Google_Service_AnalyticsReporting_Activity', \false);