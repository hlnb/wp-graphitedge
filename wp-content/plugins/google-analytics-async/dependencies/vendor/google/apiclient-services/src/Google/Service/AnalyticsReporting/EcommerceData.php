 ...
 * the License.
 */
class Google_Service_AnalyticsReporting_EcommerceData extends \Beehive\Google_Collection
{
     ...
     */
    public function setTransaction(\Beehive\Google_Service_AnalyticsReporting_TransactionData $transaction)
    {
 ...
 * the License.
 */
\class_alias('Beehive\\Google_Service_AnalyticsReporting_EcommerceData', 'Google_Service_AnalyticsReporting_EcommerceData', \false);