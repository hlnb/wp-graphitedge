 ...
 * the License.
 */
class Google_Service_AnalyticsReporting_ReportRequest extends \Beehive\Google_Collection
{
     ...
     */
    public function setCohortGroup(\Beehive\Google_Service_AnalyticsReporting_CohortGroup $cohortGroup)
    {
 ...
 * the License.
 */
\class_alias('Beehive\\Google_Service_AnalyticsReporting_ReportRequest', 'Google_Service_AnalyticsReporting_ReportRequest', \false);