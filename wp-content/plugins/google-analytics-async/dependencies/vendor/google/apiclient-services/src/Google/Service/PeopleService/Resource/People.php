...
class Google_Service_PeopleService_Resource_People extends \Beehive\Google_Service_Resource
{
     ...
     */
    public function batchCreateContacts(\Beehive\Google_Service_PeopleService_BatchCreateContactsRequest $postBody, $optParams = array())
    {
     ...
     */
    public function batchDeleteContacts(\Beehive\Google_Service_PeopleService_BatchDeleteContactsRequest $postBody, $optParams = array())
    {
        $params = array('postBody' => $postBody);
        $params = \array_merge($params, $optParams);
     ...
     */
    public function batchUpdateContacts(\Beehive\Google_Service_PeopleService_BatchUpdateContactsRequest $postBody, $optParams = array())
    {
        $params = array('postBody' => $postBody);
        $params = \array_merge($params, $optParams);
