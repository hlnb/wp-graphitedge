 ...
 * the License.
 */
class Google_Service_PeopleService_UpdateContactGroupRequest extends \Beehive\Google_Model
{
     ...
     */
    public function setContactGroup(\Beehive\Google_Service_PeopleService_ContactGroup $contactGroup)
    {
 ...
 * the License.
 */
\class_alias('Beehive\\Google_Service_PeopleService_UpdateContactGroupRequest', 'Google_Service_PeopleService_UpdateContactGroupRequest', \false);