 ...
 * @final
 */
class LimitStream implements \Beehive\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function __construct(\Beehive\Psr\Http\Message\StreamInterface $stream, $limit = -1, $offset = 0)
    {
        $this->stream = $stream;
        $this->setLimit($limit);
