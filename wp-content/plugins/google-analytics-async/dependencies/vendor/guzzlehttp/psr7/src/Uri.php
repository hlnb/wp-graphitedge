 ...
 */
class Uri implements \Beehive\Psr\Http\Message\UriInterface
{
    /**
     ...
     * @return bool
     */
    public static function isDefaultPort(\Beehive\Psr\Http\Message\UriInterface $uri)
    {
     ...
     */
    public static function isAbsolute(\Beehive\Psr\Http\Message\UriInterface $uri)
    {
     ...
     */
    public static function isNetworkPathReference(\Beehive\Psr\Http\Message\UriInterface $uri)
    {
     ...
     * @link https://tools.ietf.org/html/rfc3986#section-4.2
     */
    public static function isAbsolutePathReference(\Beehive\Psr\Http\Message\UriInterface $uri)
    {
     ...
     * @link https://tools.ietf.org/html/rfc3986#section-4.2
     */
    public static function isRelativePathReference(\Beehive\Psr\Http\Message\UriInterface $uri)
    {
        return $uri->getScheme() === '' && $uri->getAuthority() === '' && (!isset($uri->getPath()[0]) || $uri->getPath()[0] !== '/');
    }
    /**
     ...
     */
    public static function isSameDocumentReference(\Beehive\Psr\Http\Message\UriInterface $uri, \Beehive\Psr\Http\Message\UriInterface $base = null)
    {
        if ($base !== null) {
            $uri = \Beehive\GuzzleHttp\Psr7\UriResolver::resolve($base, $uri);
    ...
    {
        return \Beehive\GuzzleHttp\Psr7\UriResolver::removeDotSegments($path);
    }
    /**
     ...
     */
    public static function resolve(\Beehive\Psr\Http\Message\UriInterface $base, $rel)
    {
        if (!$rel instanceof \Beehive\Psr\Http\Message\UriInterface) {
            $rel = new self($rel);
        }
        return \Beehive\GuzzleHttp\Psr7\UriResolver::resolve($base, $rel);
    }
    /**
     ...
     * @return UriInterface
     */
    public static function withoutQueryValue(\Beehive\Psr\Http\Message\UriInterface $uri, $key)
    {
     ...
     * @return UriInterface
     */
    public static function withQueryValue(\Beehive\Psr\Http\Message\UriInterface $uri, $key, $value)
    {
        $result = self::getFilteredQueryString($uri, [$key]);
     ...
     * @return UriInterface
     */
    public static function withQueryValues(\Beehive\Psr\Http\Message\UriInterface $uri, array $keyValueArray)
    {
     ...
     * @return array
     */
    private static function getFilteredQueryString(\Beehive\Psr\Http\Message\UriInterface $uri, array $keys)
    {
