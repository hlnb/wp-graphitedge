 ...
 */
class HipChatHandler extends \Beehive\Monolog\Handler\SocketHandler
{
    /**
     * Use API version 1
     */
     ...
     */
    public function __construct($token, $room, $name = 'Monolog', $notify = \false, $level = \Beehive\Monolog\Logger::CRITICAL, $bubble = \true, $useSSL = \true, $format = 'text', $host = 'api.hipchat.com', $version = self::API_V1)
    {
    ...
    {
        switch (\true) {
            case $level >= \Beehive\Monolog\Logger::ERROR:
                return 'red';
            case $level >= \Beehive\Monolog\Logger::WARNING:
                return 'yellow';
            case $level >= \Beehive\Monolog\Logger::INFO:
                return 'green';
            case $level == \Beehive\Monolog\Logger::DEBUG:
                return 'gray';
            default:
                return 'yellow';
        }
