...
<div class="sui-wrap snapshot-page-dashboard">
	<div class="sui-header">
		...
		<?php if ( ! Settings::get_branding_hide_doc_link() ) { ?>
			<div class="sui-actions-right">
				<a href="https://wpmudev.com/docs/wpmu-dev-plugins/snapshot-4-0/?utm_source=snapshot&utm_medium=plugin&utm_campaign=snapshot_dash_docs#dashboard" target="_blank" class="sui-button sui-button-ghost">
		...
		<div class="sui-summary-segment">
			...
			<ul class="sui-list">
				...
				<li>
					...
					<span class="sui-list-detail"><span class="sui-icon-loader sui-loading snapshot-destinations-number-loading" aria-hidden="true"></span><span class="snapshot-destinations-number"></span></span>
				</li>
		...
		<div class="sui-col-lg-6">
			<div class="sui-box snapshot-dashboard-backups">
				...
				<div class="sui-box-header">
					...
					<span class="sui-icon-snapshot" aria-hidden="true"></span> <?php esc_html_e( 'Snapshot Backups', 'snapshot' ); ?>
					</h3>
				</div>
				...
				<div class="sui-box-footer">
					<a href="<?php echo esc_attr( network_admin_url() . 'admin.php?page=snapshot-backups' ); ?>" class="sui-button sui-button-ghost"><span class="sui-icon-eye" aria-hidden="true"></span><?php esc_html_e( 'View all', 'snapshot' ); ?></a>
	...
	<?php } ?>
			<div class="sui-box snapshot-dashboard-destinations">
				...
				<div class="sui-box-header">
					<h3 class="sui-box-title">
					<span class="sui-icon-cloud" aria-hidden="true"></span> <?php esc_html_e( 'Destinations', 'snapshot' ); ?>
					</h3>
				</div>
			...
			<div class="sui-box snapshot-dashboard-hosting-backups">
				...
				<div class="sui-box-body">
					...
					<div class="api-error" style="display: none;">
						...
						<button class="sui-button sui-button-ghost" role="button" id="button-reload-hosting-backups"><span class="sui-icon-refresh" aria-hidden="true"></span><?php esc_html_e( 'Reload', 'snapshot' ); ?></button>
					</div>
