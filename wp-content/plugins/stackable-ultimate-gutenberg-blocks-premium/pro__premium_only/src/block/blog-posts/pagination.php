...
if ( ! class_exists( 'Stackable_Blog_Posts_Block_Pagination' ) ) {
	class Stackable_Blog_Posts_Block_Pagination {
		...
		public static function render_pagination( $pagination_query, $attributes ) {
			...
			if ( $paged > 1 ) {
				// Add previous button.
				$pagination_links .= Stackable_Blog_Posts_Block_Pagination::generate_link_node( array(
					'classes' => array_merge(
						$button_classes,
						[ 'prev' ]
					),
			...
			foreach ( Stackable_Blog_Posts_Block_Pagination::generate_pagination_array( $paged, $total_pages ) as $text ) {
				$link_node = array(
				...
				$pagination_links .= Stackable_Blog_Posts_Block_Pagination::generate_link_node( $link_node );
			}
