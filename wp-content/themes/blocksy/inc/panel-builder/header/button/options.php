...
$options = [
	blocksy_rand_md5() => [
		...
		[
			'header_button_open' => [
				'label' => __('Open on Click', 'blocksy'),
				'type' => function_exists('blc_fs') && blc_fs()->is__premium_only() ? 'ct-select' : 'hidden',
				'value' => 'link',
				'view' => 'text',
				'design' => 'inline',
				'divider' => 'top:full',
			...
			blocksy_rand_md5() => [
				'type' => 'ct-condition',
				'condition' => [ 'header_button_open' => 'popup' ],
				'options' => function_exists('blocksy_get_default_content_block') ? [
